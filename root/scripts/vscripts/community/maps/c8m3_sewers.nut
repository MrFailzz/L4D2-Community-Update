...
{
	make_clip( "_unattackable_burgertank1", "Survivors", 1, "-80 -398 -464", "80 398 464", "10608 5006 744" );
	make_clip( "_unattackable_burgertank2", "Survivors", 1, "-8 -690 -412 ", "8 690 412", "10520 6094 796" );
	...
	make_clip( "_unattackable_wrongway1", "Survivors", 1, "-760 -384 -327", "760 384 327", "11272 4224 881" );
	make_clip( "_unattackable_wrongway2", "Survivors", 1, "-224 -288 -370", "224 288 370", "12256 4256 838" );
	make_clip( "_unattackable_wrongway3", "Survivors", 1, "-224 -384 -200", "224 384 200", "12704 4352 1008" );
	make_clip( "_unattackable_wrongway4", "Survivors", 1, "-368 -976 -518", "368 976 518", "13264 5712 690" );
	make_clip( "_unattackable_hospital1", "Survivors", 1, "-16 -466 -600", "16 466 600", "12240 11438 608" );
	make_clip( "_unattackable_hospital2", "Survivors", 1, "-988 -16 -599.5", "988 16 599.5", "13564 10832 608" );
	make_clip( "_unattackable_hospital3", "Survivors", 1, "-128 -327 -172", "128 327 172", "14680 10823 1036" );
	make_clip( "_unattackable_hospital4", "Survivors", 1, "-16 -960 -300", "16 960 300", "14800 12096 908" );
	make_clip( "_hospital_rooftop1", "Survivors", 1, "-448 -432 -316", "448 432 316", "13376 13496 892" );
	make_clip( "_hospital_rooftop2", "Survivors", 1, "-368 -568 -192", "368 568 192", "12560 13068 1016" );
	make_clip( "_hospital_rooftop3", "Survivors", 1, "-368 -300 -380", "368 300 380", "12560 12204 828" );
	make_clip( "_clipextend_warehouse1", "Survivors", 1, "-280 -772 -204", "280 772 204", "10752 7548 1004" );
	...
	{
		make_clip( "_unattackable_wrongway5", "Survivors", 1, "-500 -820 -204", "500 820 204", "13196 7500 1004" );
		make_clip( "_clipextend_warehouse2", "Survivors", 1, "-848 -396 -204", "848 396 204", "11856 7924 1004" );
