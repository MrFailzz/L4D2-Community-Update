...
function DoRoundFixes()
{
	...
	make_clip( "_cliprework_church08", "Survivors", 1, "-86 -92 -472", "86 92 472", "-5454 644 968");
	make_clip( "_cliprework_church09", "Survivors", 1, "-88 -192 -447.5", "88 192 447.5", "-3640 -320 992" );
	...
	make_clip( "_cliprework_cliff1", "Survivors", 1, "-252 -8 -751.5", "252 8 751.5", "-8356 -4620 688" );
	make_clip( "_cliprework_cliff2", "Survivors", 1, "-8 -394 -751.5", "8 394 751.5", "-8112 -4218 688" );
