...
{
	make_clip( "_unattackable_saferooma", "Survivors", 1, "-368 -98 -176", "368 98 176", "-8592 -7374 816" );
	make_clip( "_unattackable_saferoomb", "Survivors", 1, "-16 -1352 -368", "16 1352 368", "-8208 -6696 624" );
	make_clip( "_commonhop_traintoroof", "Survivors", 1, "-520 -198 -396", "520 198 396", "-11776 -7530 596" );
	make_clip( "_commonhop_stationroof", "Survivors", 1, "-176 -400 -324", "176 400 324", "-12640 -6064 668" );
	make_clip( "_dispcrouch_flatcartunnel", "Everyone", 1, "-100 -38 -64", "38 38 256", "-12534 -3574 -36" );
	make_clip( "_cliprework_roadblock", "Survivors", 1, "-42 -766 -472", "42 766 472", "-4586 -1282 968" );
	make_clip( "_cliprework_herscha", "Survivors", 1, "-704 -24 -264", "704 24 264", "-10560 -7704 728" );
	make_clip( "_cliprework_herschb", "Survivors", 1, "-816 -256 -240", "816 256 240", "-9040 -7728 752" );
	make_clip( "_clipextend_trainstationa", "Survivors", 1, "-22 -522 -324", "22 522 324", "-12810 -6970 668" );
	make_clip( "_clipextend_trainstationb", "Survivors", 1, "-448 -134 -324", "448 134 324", "-13248 -5728 668" );
	make_clip( "_clipextend_trainstationc", "Survivors", 1, "-246 -16 -468", "246 16 468", "-12542 -7480 528" );
	make_clip( "_dipscrouch_multicliff", "Everyone", 1, "-487 -60 -100", "86 4 39", "-13282 -3756 240", "0 43 0" );
	make_clip( "_cliprework_church01", "Survivors", 1, "-854 -12 -472", "854 12 472", "-4582 -504 968" );
	make_clip( "_cliprework_church02", "Survivors", 1, "-212 -184 -448", "212 184 448", "-3516 -308 992" );
	make_clip( "_cliprework_church03", "Survivors", 1, "-278 -82 -472", "278 82 472", "-3054 -46 968" );
	make_clip( "_cliprework_church04", "Survivors", 1, "-56 -528 -472", "56 528 472", "-2280 464 968" );
	make_clip( "_cliprework_church05", "Survivors", 1, "-544 -56 -472", "544 56 472", "-2768 1048 968" );
	make_clip( "_cliprework_church06", "Survivors", 1, "-510 -138 -472", "510 138 472", "-3822 966 968" );
	make_clip( "_cliprework_church07", "Survivors", 1, "-212 -186 -472", "212 186 472", "-4544 662 968" );
	make_clip( "_cliprework_church08", "Survivors", 1, "-306 -12 -472", "306 12 472", "-5062 712 968");
	make_clip( "_cliprework_church09", "Survivors", 1, "-86 -92 -472", "86 92 472", "-5454 644 968" );
	make_clip( "_cliprework_church10", "Survivors", 1, "-12 -480 -472", "12 480 472", "-5528 72 968" );
	make_clip( "_cliprework_church11", "Survivors", 1, "-224 -352 -392", "224 352 392", "-2560 288 1048" );
	make_clip( "_cliprework_church12", "Survivors", 1, "-144 -160 -392", "144 160 392", "-2928 448 1048" );
	...
	make_clip( "_cliprework_rockcliff01", "Survivors", 1, "-1014 -310 -768", "1014 310 768", "-6834 -3030 672" );
	make_clip( "_cliprework_rockcliff02", "Survivors", 1, "-1158 -66 -768", "798 66 768", "-8470 -3236 672", "0 35 0" );
	make_clip( "_cliprework_rockcliff03", "Survivors", 1, "-581.5 -88 -768", "771.5 88 768", "-9072 -4292 672", "0 -44 0" );
	...
	if ( g_BaseMode == "versus" )
	{
		...
		make_clip( "_chargerassist_brokenwall", "Survivors", 1, "-64 -192 -92", "64 192 92", "-2304 160 224" );
	}
