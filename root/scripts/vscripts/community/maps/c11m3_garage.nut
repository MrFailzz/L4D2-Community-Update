...
PrecacheModel( "models/props_urban/fire_escape_upper.mdl" );
PrecacheModel( "models/props_urban/fire_escape_lower.mdl" );
PrecacheModel( "models/props_pipes/concrete_pipe001a.mdl" );
PrecacheModel( "models/props_urban/metal_plate001.mdl" );
PrecacheModel( "models/props_equipment/scaffolding.mdl" );
PrecacheModel( "models/props_misc/wrongway_sign01_optimized.mdl" );
PrecacheModel( "models/props_rooftop/acvent01.mdl" );
PrecacheModel( "models/props_update/c11m3_nodraw_cinderwall.mdl" );
PrecacheModel( "models/props_update/c11m3_wrongway_curb.mdl" );
PrecacheModel( "models/props_vehicles/van.mdl" );
PrecacheModel( "models/props_vehicles/van_glass.mdl" );
PrecacheModel( "models/props_update/c11m3_wrongway_fence.mdl" );
PrecacheModel( "models/props_junk/wood_crate002a.mdl" );
