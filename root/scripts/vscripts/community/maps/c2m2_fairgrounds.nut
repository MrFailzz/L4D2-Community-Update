...
PrecacheModel( "models/props_foliage/urban_hedge_128_64_high.mdl" );
...
PrecacheModel( "models/props_urban/chimney001.mdl" );
PrecacheModel( "models/props_misc/wrongway_sign01_optimized.mdl" );
PrecacheModel( "models/props_update/c2m2_fairgroundwall.mdl" );
PrecacheModel( "models/props/cs_assault/forklift.mdl" );
