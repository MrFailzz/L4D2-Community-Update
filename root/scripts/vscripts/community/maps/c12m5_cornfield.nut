...
function DoRoundFixes()
{
	...
	if ( HasPlayerControlledZombies() )
	{
		...
		make_clip( "_ladder_barnhouseicing_clip", "SI Players", 1, "-2 -12 -13", "2 12 13", "6841 119 383", "45 0 0" );
		...
		make_ladder( "_ladder_barnhouseicing_cloned_barnhousefront", "7100 266.5 301.922", "6938 -6981 68", "0 90 38", "-1 0 0" );
		...
		make_ladder( "_ladder_boxcardeadend_cloned_housegenerator", "7119 887.5 296", "3539 2398 -226", "0 10.58 0", "0.18 -0.98 0" );
		...
		make_ladder( "_ladder_permstuck_cloned_toolshed", "7101 2140.5 275", "3916 6982 -198", "0 -34 0", "0.56 0.83 0" );
		make_ladder( "_ladder_siloleftT_cloned_haybalebarn", "8128 131.5 374.5", "12447 -3557 420", "0 128 0", "0.788 0.62 0" );
		make_ladder( "_ladder_siloleftB_cloned_haybalebarn", "8128 131.5 374.5", "12447 -3557 68", "0 128 0", "0.788 0.62 0" );
		make_ladder( "_ladder_silorightT_cloned_haybalebarn", "8128 131.5 374.5", "12798 -3557 420", "0 128 0", "0.788 0.62 0" );
		make_ladder( "_ladder_silorightB_cloned_haybalebarn", "8128 131.5 374.5", "12798 -3557 68", "0 128 0", "0.788 0.62 0" );
