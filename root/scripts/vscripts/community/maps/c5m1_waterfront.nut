...
function DoRoundFixes()
{
	...
	make_clip( "_permstuck_dropbehindfence1", "Everyone", 1, "-226 -7 -104", "294 41 177", "-982 -2793 144" );
	make_clip( "_permstuck_dropbehindfence2", "Survivors", 1, "-204 -32 -176", "204 32 176", "-2984 -1504 -40" );
