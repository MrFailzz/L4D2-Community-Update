...
function DoRoundFixes()
{
	...
	make_clip( "_commentary_ledgedrop_a", "Survivors", 1, "-68 -16 -44", "4 288 8", "2516 6192 2646" );
	make_clip( "_commentary_ledgedrop_b", "Survivors", 1, "-166 -8 -44", "18 4 8", "2502 6486 2646" );
	make_clip( "_commentary_ledgedrop_c", "Survivors", 1, "-4 -1182 -44", "4 16 8", "2340 7672 2646" );
	make_clip( "_commentary_ledgedrop_d", "Survivors", 1, "4 0 8", "-44 -8 -44", "2332 7688 2646" );
