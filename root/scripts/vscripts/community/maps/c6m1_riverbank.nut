...
{
	make_clip( "_permstuck_floodlight01", "Everyone", 1, "-10 -10 -4", "10 10 4", "1902 1890 376" );
	make_clip( "_permstuck_floodlight02", "Everyone", 1, "-10 -10 -4", "10 10 4", "1926 1778 356" );
	make_clip( "_permstuck_tarptree", "Everyone", 1, "-17 -69 -17", "17 17 17", "1166 3794 191" );
	make_clip( "_commonhop_windowsill", "Survivors", 1, "-16 -232 -444", "16 232 444", "528 2856 684" );
	...
	make_clip( "_cliprework_startroof", "Survivors", 1, "-344 -599.5 -392", "344 599.5 392", "360 3688 736" );
	...
	{
		make_clip( "_ghostgrief_tarpledge", "Survivors", 1, "-8 -338 -516", "8 338 516", "1148 4338 612" );
		make_clip( "_cliprework_bridge", "Survivors", 1, "-292 -166 -409.5", "292 166 409.5", "912 4594 718" );
		make_clip( "_cliprework_bridgefence", "Survivors", 1, "-8 -194 -451.5", "8 194 451.5", "704 4482 676" );
