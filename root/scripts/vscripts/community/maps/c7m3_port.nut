...
function DoRoundFixes()
{
	...
	make_clip( "_booster_generator_side", "Survivors", 1, "-30 -16 -462", "30 16 462 ", "1846 734 562" );
	...
	make_clip( "_booster_telepole2", "Survivors", 1, "-54 -52 -231", "54 52 231", "254 1124 793" );
	make_clip( "_booster_telepole5", "Survivors", 1, "-54 -52 -311", "54 52 311", "254 156 713" );
	...
	if ( g_BaseMode != "coop" && g_BaseMode != "realism" )
	{
		...
		make_clip( "_booster_bridge_TMP3", "Survivors", 1, "-78 -67 0", "89 20 864", "359 -788 160" );
		make_clip( "_booster_bridge_TMP4", "Survivors", 1, "-21 -420 0", "88 88 888", "230 -849 216" );
